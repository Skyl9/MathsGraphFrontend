...
import { Box, IconButton, Tooltip, Popover, Typography, Divider } from "@mui/material";
    ...
    return (
        <Box className="graph-hud-container">
            ...
            >
                ...
                <Tooltip title="Concept précédent">
                    <span>
                        <IconButton
                            size="small"
                            onClick={goBack}
                ...
                <Divider orientation="vertical" variant="middle" flexItem sx={{ opacity: 0.3, mx: 0.5 }} />
                ...
                {/* Aide raccourcis */}
                <Tooltip title="Raccourcis clavier">
                    <IconButton
                        aria-describedby={id}
                        size="small"
            ...
            >
                <Box className="shortcuts-popover">
                    ...
                    <Box className="shortcut-row">
                        <Typography variant="caption">Naviguer à droite</Typography>
                        <span className="shortcut-key">D</span>
                    </Box>
                    <Box className="shortcut-row">
                        <Typography variant="caption">Naviguer à gauche</Typography>
                        <span className="shortcut-key">Q</span>
                    </Box>
                    <Box className="shortcut-row">
                        <Typography variant="caption">Concept suivant</Typography>
                        <span className="shortcut-key">→</span>
                    </Box>
                    <Box className="shortcut-row">
                        <Typography variant="caption">Concept précédent</Typography>
                        <span className="shortcut-key">←</span>
                    </Box>
                    <Box className="shortcut-row">
                        <Typography variant="caption">Activer le mode Debug</Typography>

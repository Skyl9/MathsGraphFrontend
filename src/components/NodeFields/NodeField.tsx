...
const NodeField: React.FC<NodeFieldProps> = ({ field, data, onEdit, editable = true }) => {
  if (!data) return null;
  ...
  return (
    <div className="node-wrapper">
      <div className="field-title">{field.charAt(0).toUpperCase() + field.slice(1).replace('_', ' ')} :</div>

                    ...
                    {showAdd ? (
                        ...
                        >
                            <Autocomplete
                                ...
                                options={allTags.filter(opt => !tagList.some(t => t.tag === opt.tag))}
                                ...
                                filterOptions={(options, state) => {
                                    ...
                                    const filtered = options.filter(
                                        opt => !tagList.some(t => t.tag === opt.tag) && opt.tag.toLowerCase().includes(input.toLowerCase())
                                    );
                                    if (input !== '' && !allTags.some(opt => opt.tag.toLowerCase() === input.toLowerCase())) {
                                        filtered.push({ id: Number.MIN_SAFE_INTEGER, tag: `Créer "${input}"` } as Tag);
                                    }
                                    return filtered;
                                }}
                                onKeyDown={e => {

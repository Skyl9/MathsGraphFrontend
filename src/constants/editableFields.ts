...
export const createEditableFields = (
  options: Record<keyof AllNodeData, string[]>,
): Record<keyof AllNodeData, EditableField> => ({
...
> => ({
  ...
  domaines: { label: "Domaines", type: "text" },
  url: { label: "URL", type: "text" },
  recompense: { label: "Récompenses", type: "text" },
...
export const createCategoryEditableFields = (
  options: Record<keyof Category, string[]>,
): Record<keyof Category, EditableField> => ({
  id: { label: "ID", type: "none" },
  nom: { label: "Nom", type: "text" },

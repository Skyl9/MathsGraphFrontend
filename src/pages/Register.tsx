...
import { TextField, Button, Alert, Box, Typography, Paper, Grid, Stack, Link, useTheme } from '@mui/material';
                    ...
                    >
                        <Box component="form" onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
                                Créez vos identifiants pour rejoindre le projet.
                            </Typography>

                            {apiError && <Alert severity="error" sx={{ mb: 3, borderRadius: 2 }}>{apiError}</Alert>}
                            {apiSuccess && <Alert severity="success" sx={{ mb: 3, borderRadius: 2 }}>{apiSuccess}</Alert>}

    ...
    return (
      <Box sx={{ p: 2 }}>
        <Alert severity="error">
          {error instanceof Error ? error.message : 'Une erreur est survenue lors du chargement des contenus.'}
        </Alert>
      </Box>
    );
  }
      ...
      <Box sx={{ mb: 4, display: 'flex', flexDirection: { xs: 'column', sm: 'row' }, justifyContent: 'space-between', alignItems: { xs: 'stretch', sm: 'center' }, gap: 2 }}>
        <Box>
          ...
          <Typography variant="body2" color="text.secondary">
            Gérer les fiches de concepts mathématiques, catégories et biographies des mathématiciens.
          </Typography>
        </Box>

            ...
            <Box sx={{ mb: 4, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <Box>
                    ...
                    <Typography variant="body2" color="text.secondary">
                        Ajoutez une nouvelle fiche conceptuelle, théorème ou définition à la base de connaissances.
                    </Typography>
                </Box>
                <Button
                    variant="outlined"
                        ...
                        <Stack spacing={3}>
                            <Paper elevation={0} sx={glassPaperStyle}>
                                ...
                                <Stack spacing={3}>
                                    ...
                                    >
                                        <MenuItem value=""><em>Aucune catégorie</em></MenuItem>
                                    ...
                                    >
                                        <MenuItem value=""><em>Aucun mathématicien</em></MenuItem>

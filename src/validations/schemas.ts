...
export const mathematicienSchema = z.object({
    ...
    nationalite: z.string().max(50, "Nationalité trop longue").optional().or(z.literal('')),
    domaine: z.string().max(100, "Domaine trop long").optional().or(z.literal('')),
    url: z.string().url("L'URL doit être valide (ex: https://...)").optional().or(z.literal('')),
    date_naissance: dateSchema,
    date_deces: dateSchema,
    recompenses: z.string().max(200, "Texte trop long").optional().or(z.literal('')),
